        ...
        <div className="relative z-10 max-w-[1440px] w-full mx-auto px-6 sm:px-10 lg:px-16 pb-16 lg:pb-24 pt-32">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap items-center gap-6">
              <Link className="group inline-flex items-center gap-3 bg-secondary-fixed text-on-secondary-fixed px-7 py-3.5 rounded-full text-xs uppercase tracking-[0.22em] font-medium hover:bg-secondary hover:text-surface transition-all duration-300 shadow-lg" href="/shop">
        ...
        <div className="max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-16">
          <div className="relative overflow-hidden rounded-xl border border-outline-variant/30 min-h-[520px] lg:min-h-[640px] flex items-end">
            ...
            <div className="relative z-10 p-8 sm:p-12 lg:p-16 max-w-2xl">
              ...
              <Link className="inline-flex items-center gap-3 bg-primary-container hover:bg-primary text-surface-bright px-6 py-3.5 rounded-full text-xs uppercase tracking-[0.22em] font-medium transition-all shadow-md" href="/shop">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">{/*  TIER 1: Asymmetric Pair (5 cols vs 7 cols)  */}
            <div className="lg:col-span-5 group flex flex-col">
              <div className="relative overflow-hidden rounded-xl bg-surface-container-high aspect-[3/4] border border-outline-variant/50 shadow-sm">
                ...
                <div className="absolute inset-x-5 bottom-5 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <button className="w-full bg-surface text-primary py-3 rounded-full text-xs uppercase tracking-[0.2em] font-medium shadow-lg hover:bg-primary-container hover:text-surface transition-all flex items-center justify-center gap-2 cursor-pointer" onClick={() => addToCart({ id: 'ivory-silk-asymmetric-bandhgala', name: 'The Ivory Silk Asymmetric Bandhgala', edition: 'Edition // No. VII - 04', price: 84000, formattedPrice: '₹ 84,000', image: 'https://lh3.googleusercontent.com/aida/AOf_eG6zB01G100rF03mB9L41X6bNqJvQy19nE5R3mS8=s1600', size: '40R', colorway: 'Ivory Sand' })}>
            ...
            <div className="lg:col-span-7 flex flex-col gap-6">
              <div className="group relative overflow-hidden rounded-xl bg-surface-container-high aspect-[4/3] border border-outline-variant/50 shadow-sm">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-tertiary/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6 sm:p-8">
                  <button className="bg-surface text-primary px-8 py-3 rounded-full text-xs uppercase tracking-[0.2em] font-medium shadow-xl hover:bg-primary-container hover:text-surface transition-all flex items-center gap-2 cursor-pointer" onClick={() => addToCart({ id: 'sculpted-crimson-zardozi-lehenga', name: 'The Sculpted Crimson Zardozi Lehenga', edition: 'Edition // No. VII - 01', price: 145000, formattedPrice: '₹ 1,45,000', image: 'https://lh3.googleusercontent.com/aida/AOf_eG674fJ9w94oY_l2oW0h5W7vA1Lg5p9X4K1h=s1600', size: '38R', colorway: 'Crimson Vermilion' })}>
                    <span className="material-symbols-outlined text-sm" data-icon="add">add</span> QUICK ADD TO BAG
                  </button>
                </div>
              </div>
            ...
            <div className="lg:col-span-4 group flex flex-col justify-between">
              <div className="relative overflow-hidden rounded-xl bg-surface-container-high aspect-[3/4] border border-outline-variant/50 shadow-sm">
                ...
                <div className="absolute inset-x-4 bottom-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <button className="w-full bg-surface text-primary py-2.5 rounded-full text-[11px] uppercase tracking-[0.2em] font-medium shadow-md hover:bg-primary-container hover:text-surface transition-all flex items-center justify-center gap-1.5 cursor-pointer" onClick={() => addToCart({ id: 'sandstone-raw-silk-bandhgala', name: 'Sandstone Raw Silk Structured Bandhgala', edition: 'Edition // No. VII - 06', price: 76000, formattedPrice: '₹ 76,000', image: 'https://lh3.googleusercontent.com/aida/AOf_eG6zB01G100rF03mB9L41X6bNqJvQy19nE5R3mS8=s1600', size: '42R', colorway: 'Sandstone Gold' })}>
            ...
            <div className="lg:col-span-7 group flex flex-col">
              <div className="relative overflow-hidden rounded-xl bg-surface-container-high aspect-[16/10] border border-outline-variant/50 shadow-sm">
                ...
                <div className="absolute inset-x-6 bottom-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <button className="w-full bg-surface text-primary py-3 rounded-full text-xs uppercase tracking-[0.2em] font-medium shadow-lg hover:bg-primary-container hover:text-surface transition-all flex items-center justify-center gap-2 cursor-pointer" onClick={() => addToCart({ id: 'banarasi-tissue-corset-saree', name: 'Banarasi Tissue Corset Saree', edition: 'Edition // No. VII - 08', price: 98000, formattedPrice: '₹ 98,000', image: 'https://lh3.googleusercontent.com/aida/AOf_eG5R8c3H3mY3JkL0p6uO1jY7kQ3mZ=s1600', size: 'Custom Drape', colorway: 'Antique Zari' })}>
                    <span className="material-symbols-outlined text-sm" data-icon="add">add</span> QUICK ADD TO BAG
                  </button>
                </div>
              </div>
            ...
            <div className="lg:col-span-5 group flex flex-col">
              <div className="relative overflow-hidden rounded-xl bg-surface-container-high aspect-[3/4] border border-outline-variant/50 shadow-sm">
                ...
                <div className="absolute inset-x-4 bottom-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <button className="w-full bg-surface text-primary py-2.5 rounded-full text-[11px] uppercase tracking-[0.2em] font-medium shadow-md hover:bg-primary-container hover:text-surface transition-all flex items-center justify-center gap-1.5 cursor-pointer" onClick={() => addToCart({ id: 'layered-raw-silk-angrakha', name: 'Layered Raw Silk Angrakha', edition: 'Edition // No. VII - 09', price: 68000, formattedPrice: '₹ 68,000', image: 'https://lh3.googleusercontent.com/aida/AOf_eG4o1qH7l3R1s9P2b=s1600', size: '40R', colorway: 'Nocturne Black' })}>
                    <span className="material-symbols-outlined text-sm" data-icon="add">add</span> QUICK ADD
                  </button>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="group relative overflow-hidden rounded-xl bg-tertiary aspect-[3/4] flex flex-col justify-end p-8 sm:p-12" id="menswear">
              ...
              <div className="relative z-10">
                ...
                <Link className="inline-flex items-center gap-2 text-xs uppercase tracking-[0.22em] text-surface-bright font-medium group-hover:translate-x-1 transition-transform" href="/shop">
