...
import { SvgCornerArt } from "@/components/SvgCornerArt";
...
export default async function ProductDetailPage({ params }: ProductPageProps) {
  ...
  return (
    <div className="w-full  relative overflow-hidden">
      ...
      <SvgCornerArt color="text-[#4A1118]" src="/hibiscus-vine-stroke.svg" className="-scale-y-100 -rotate-110 mt-8 -ml-5"  position="top-left" animation="draw" size="w-24 sm:w-36 lg:w-90" />
      <SvgCornerArt color="text-[#4A1118]" src="/hibiscus-vine-stroke.svg" className="-scale-y-100 -rotate-110 mb-10 -mr-2"  position="bottom-right" animation="draw" size="w-24 sm:w-36 lg:w-90" />

      <div className="relative pt-32 pb-32 px-6 md:px-12 lg:px-20 max-w-[1600px] mx-auto overflow-hidden my-15">
